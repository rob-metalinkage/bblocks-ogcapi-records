...
`ogc.api.records.schemas.landingPage` *v0.1*
...
* YAML version: [schema.yaml](https://ogcincubator.github.io/bblocks-ogcapi-records/build/annotated/api/records/schemas/landingPage/schema.json)
* JSON version: [schema.json](https://ogcincubator.github.io/bblocks-ogcapi-records/build/annotated/api/records/schemas/landingPage/schema.yaml)
...
* Path: `_sources/schemas/landingPage`
